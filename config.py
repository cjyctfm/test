...
SRC_EMAIL ="no.0ne.pip3@gmail.com" # "wyhgyhj@163.com" #"akindleear@gmail.com"  #Your gmail account for sending mail to Kindle
DOMAIN = "http://kindlepw.appspot.com/" #Your domain of app
